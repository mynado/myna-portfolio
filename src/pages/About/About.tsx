  ...
  return (
    <div className="p-4 max-w-5xl mx-auto">
      ...
      <section id="about-me">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <p className="text-gray-700">
                ...
                Playwright for E2E validation. I prioritize SEO and WCAG from
            ...
            <div>
              ...
              <p className="text-gray-700">
                ...
                such as creating a CSS library managed as an npm package to
        ...
        <div className="bg-lavender-200 p-4 rounded-lg mt-10">
          <h2 className="text-2xl font-semibold mb-4">
          ...
          <ul className="mt-4">
            ...
            <li className="list-disc ml-6 mt-2">
              ...
              management and self-direction, ensuring complex deliverables are
